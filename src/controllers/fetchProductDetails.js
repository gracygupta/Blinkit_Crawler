...
const fetchAllProductsByCity = async (req, res) => {
    ...
    try {
        ...
        if (querySnapshot.empty) {
            return ReS(res, constants.not_found_code, 'No products found for the specified city');
        }
...
//         return ReS(res, constants.success_code, 'Fetched product details successfully', products);
...
//         // Step 3: Fetch product details for each category with a delay
//         const products = [];

//         for (const category of categories) {
//             for (const sub of category.subcategories) {
//                 // Run the worker for the current category and subcategory
//                 const result = await runWorker(city, category.l0_cat, sub.l1_cat);
//                 products.push(result);

//                 // Introduce a delay of 1 second (1000 milliseconds) between worker executions
//                 // await delay(30);
//             }
//         }
